...
//            add(ModBlock.greekFire);
        ...
        moveSensitiveBlocks = new ArrayList<Block>(){{
            ...
            add(Blocks.PISTON);//these ones may be co-dependent :?
...
//            add(ModBlock.greekFire);
    ...
    void initializeEnergyRegistry()
    {
        ...
        addBlock(Blocks.ACACIA_DOOR, 48);
        addBlock(Blocks.BIRCH_DOOR, 48);
        addBlock(Blocks.JUNGLE_DOOR, 48);
        addBlock(Blocks.OAK_DOOR, 48);
        addBlock(Blocks.SPRUCE_DOOR, 48);
        addBlock(Blocks.DARK_OAK_DOOR, 48);
        ...
        addBlock(Blocks.ACACIA_FENCE, 12);
        addBlock(Blocks.BIRCH_FENCE, 12);
        addBlock(Blocks.JUNGLE_FENCE, 12);
        addBlock(Blocks.OAK_FENCE, 12);
        addBlock(Blocks.SPRUCE_FENCE, 12);
        addBlock(Blocks.DARK_OAK_FENCE, 12);
        ...
        addBlock(Blocks.ACACIA_FENCE_GATE, 12);
        addBlock(Blocks.BIRCH_FENCE_GATE, 12);
        addBlock(Blocks.JUNGLE_FENCE_GATE, 12);
        addBlock(Blocks.OAK_FENCE_GATE, 12);
        addBlock(Blocks.SPRUCE_FENCE_GATE, 12);
        addBlock(Blocks.DARK_OAK_FENCE_GATE, 12);
